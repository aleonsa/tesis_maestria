...
%
% Compara 3 modelos de BEMF en el controlador:
%   TRAP    - Modelo trapezoidal ideal
%   SIN     - Modelo senoidal puro
%   LEARNED - Modelo aprendido (NN/LUT)
%
...
if isfile('bemf_lut.mat')
    ...
    error('Falta bemf_lut.mat. Ejecutar generate_lut.py primero.');
end
