...
\begin{frame}{Paper 1: Moreno 2020 - Discontinuous PID for SISO Systems}
  ...
  \begin{columns}
    ...
    \begin{column}{0.35\textwidth}
      ...
      \only<3>{
        \begin{alertblock}{BIBS Problem}
          For manipulators:
          $$C(q,\dot{q})\dot{q} \propto \|\dot{q}\|^2$$
          States grow quadratically, violating BIBS assumption
        \end{alertblock}
      }
  ...
  \begin{column}{0.65\textwidth}
     ...
     \only<1>{
       ...
       \begin{itemize}
         ...
         \item Discontinuous integral $\psi(\bar{x}_\rho)$
