...
\begin{frame}{Resultados: Comparación de 6 Métodos}
    ...
    \begin{tabular}{@{}lccr@{}}
    \toprule
    \textbf{Método} & \textbf{Ripple [\%]} & \textbf{$\omega$ P-P [rad/s]} & \textbf{Params} \\
    \midrule
    TRAP (baseline)            & 4.20 & 0.399 & --- \\
    SIN                        & 3.77 & 0.230 & --- \\
    \textbf{LEARNED (NN)}      & 3.65 & 0.243 & $\sim$25k \\
    \textbf{ADALINE offline}   & 3.65 & 0.243 & \textbf{40} \\
    \textbf{ADALINE on (TRAP)} & 3.90 & 0.201 & \textbf{40} \\
    \textbf{ADALINE on (SIN)}  & 3.81 & 0.202 & \textbf{40} \\
    \bottomrule
    \end{tabular}
    \end{table}
    ...
    \begin{itemize}
        ...
        \item \textbf{Reducción de ripple vs.\ TRAP: $\sim$9\%} --- el motor se auto-calibra.
    \end{itemize}
\end{frame}
